...
query = readRDS('snRNAseq/processed_data/transfer_learning/datasets/RL2986.RDS') 
...
saveRDS(latent, 'snRNAseq/processed_data/transfer_learning/outs/RL2986_latent.RDS')
saveRDS(qlatent, 'snRNAseq/processed_data/transfer_learning/outs/RL2986_qlatent.RDS')
...
saveRDS(qumap, file="snRNAseq/processed_data/RL2986_umap.RDS")
