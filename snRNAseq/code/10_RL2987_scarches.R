...
query = readRDS('snRNAseq/processed_data/transfer_learning/datasets/RL2987.RDS') 
...
saveRDS(latent, 'snRNAseq/processed_data/transfer_learning/outs/RL2987_latent.RDS')
saveRDS(qlatent, 'snRNAseq/processed_data/transfer_learning/outs/RL2987_qlatent.RDS')
...
saveRDS(qumap, file="snRNAseq/processed_data/RL2987_umap.RDS")
