...
for(i in all_samples){
    ...
    ind_n_fetal <- sce[[i]]$predstage != "Fetal"
...
write.table(go_pn_up@result[,-8], file="snRNAseq/processed_data/GO_PN_up.tsv",
            quote=F, sep="\t")
write.table(go_pn@result[,-8], file="snRNAseq/processed_data/GO_PN.tsv",
            quote=F, sep="\t")
write.table(go_pn_down@result[,-8], file="snRNAseq/processed_data/GO_PN_down.tsv",
            quote=F, sep="\t")
