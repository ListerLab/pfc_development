...
life_expectancy <- read_xlsx("Life_expectancy.xlsx")
...
postnatal <- read_xlsx("Single cell studies database-Specifics.xlsx", sheet=2)
...
fetal <- read_xlsx("Single cell studies database-Specifics.xlsx", sheet=1)
...
ggsave(gg_fetal, file="figures/fetal_studies.svg", height=1.68, width=2.96)
...
ggsave(gg_childhood, file="figures/child_studies.svg", height=1.68, width=2.96)
...
ggsave(gg_adol, file="figures/adol_studies.svg", height=1.68, width=2.96)
...
ggsave(gg_adult, file="figures/adult_studies.svg", height=1.68, width=2.96)
