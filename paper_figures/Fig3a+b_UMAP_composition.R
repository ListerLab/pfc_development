...
ggsave(g1, file="paper_figures/Fig4a_Anno.png", height=7, width=7)
...
ggsave(g1, file="paper_figures/Fig3a_Maturation.png", height=5.3, width=4.9)
...
ggsave(g1, file="paper_figures/Fig3b_Composition.svg", 
