...
ggsave(g1, file="supp_figures/SuppFig5_Annotation.png", height=7, width=7)
...
ggsave(g1, file="supp_figures/SuppFig5_TSSEnrich.png", height=7, width=7)
...
ggsave(g1, file="supp_figures/SuppFig5_AnnotationGenome.svg", height=5, 
       width=5.5)
